...
public class SegmentView extends LinearLayout {
    ...
    private void initView() {
        ...
        // 初始化的默认文字
        leftTextView.setText("正常");
        rightTextView.setText("暂停服务");
        ...
        // 设置textview的内边距
        leftTextView.setPadding(10, 12, 10, 12);
        rightTextView.setPadding(10, 12, 10, 12);

        // 设置文字大小
        setSegmentTextSize(30);
    ...
    public interface onSegmentViewClickListener {
         void onSegmentViewClick(View view, int postion);
    }
